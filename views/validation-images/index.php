...
/* @var $searchModel app\models\search\ValidationImagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Validation Images');
...
<div class="index-page kt-portlet">
    ...
    <div class="kt-portlet__body">
        ...
        <p>
            <?= Html::a(Yii::t('app', 'Create Validation Images'), ['create'], ['class' => 'btn btn-primary']) ?>
        </p>
            ...
            'columns' => [
                ...
                [
                    ...
                    "value" => function ($model) {
                        return Html::a($model->validation->prettyName, "./index.php?r=validation/view&id=$model->validation_id", [
                            "target" => "_blank",
                            "data-pjax" => "0"
                        ]);
                    },
